...
'''Base functions of Cracker'''

base_functions__auth = 'Lasercata'
base_functions__last_update = '31.08.2020'
base_functions__version = '2.3,1'
...
from modules.base.console.color import cl_inp, cl_out, c_error
